...
class ExamplesControllerTest < ActionController::TestCase
  ...
  test "should create example" do
    assert_difference('Example.count') do
      post :create, example: { description: @example.description, image: @example.image, project_id: @example.project_id }
    end
  ...
  test "should update example" do
    patch :update, id: @example, example: { description: @example.description, image: @example.image, project_id: @example.project_id }
    assert_redirected_to example_path(assigns(:example))
  end
